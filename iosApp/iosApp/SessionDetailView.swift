                            ...
                            Text(session.type.displayName)
                                ...
                                .background(
                                    session.type == .keynote
                                        ? AnyShapeStyle(LinearGradient(colors: [Color.googleBlue, Color(hex: 0xA142F4)], startPoint: .leading, endPoint: .trailing))
                                    ...
                                    RoundedRectangle(cornerRadius: 2)
                                        .fill(
                                            session.registered >= session.capacity
                                                ? LinearGradient(colors: [Color.googleRed, Color(hex: 0xFF6B6B)], startPoint: .leading, endPoint: .trailing)
                                                : LinearGradient(colors: [Color.googleBlue, Color.googleBlue.opacity(0.5)], startPoint: .leading, endPoint: .trailing)
                                        )
