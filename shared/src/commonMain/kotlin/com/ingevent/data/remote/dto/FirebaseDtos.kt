...
import com.ingevent.data.model.DEFAULT_HOME_DESCRIPTION
import com.ingevent.data.model.DEFAULT_HOME_TITLE
...
private fun Map<String, FirebaseConferenceDto>.selectedConferences(
    ...
    return values
        .filter { it.title.contains("ING Event", ignoreCase = true) }
