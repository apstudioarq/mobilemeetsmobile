...
import com.ingevent.data.seed.DesignSeedData
import com.ingevent.data.remote.dto.SessionDto
import com.ingevent.data.remote.dto.SpeakerDto
import com.ingevent.data.remote.auth.FirebaseAuthSession
...
class LocalDataSource(driverFactory: DatabaseDriverFactory) : FirebaseAuthSessionStore {
    ...
    private val database = INGEventDatabase(driverFactory.createDriver())
    private val sessionQueries = database.iNGEventDatabaseQueries
